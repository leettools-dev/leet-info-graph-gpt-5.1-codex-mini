...
- Added `SessionRouter` with CRUD endpoints for research sessions and chat messages, including authentication/authorization safeguards and JWT verification.
## Next Up
